Services = (function() {
    ...
    var Templating = function() {
        ...
        imag1 = "<img width='100%' class='imag rounded img' src='"+img+"'/>";
        ...
        imag6 = "<img width='100%' class='imag rounded img' src='"+img+"'/>";
        imagx6 = "<img width='100%' src='"+img+"'/>";
        var img = "http://goiena.net/site_media/photologue/photos/cache/P1013241_display.JPG";
        imag7 = "<img width='100%' class='imag rounded img' src='"+img+"'/>";
        imagx7 = "<img width='100%' src='"+img+"'/>";


        var K2 = "<img width='100%' class='imag rounded img' src='./assets/images/K2.jpg'/>";
        var K3 = "<img width='100%' class='imag rounded img' src='./assets/images/K3.jpg'/>";
        var K4 = "<img width='100%' class='imag rounded img' src='./assets/images/K4.jpg'/>";
        var K5 = "<img width='100%' class='imag rounded imgY4' src='./assets/images/K5.jpg'/>";
        var K6 = "<img width='100%' class='imag rounded img' src='./assets/images/K6.jpg'/>";
        var K7 = "<img width='100%' class='imag rounded img' src='./assets/images/K7.jpg'/>";
        var K8 = "<img width='100%' class='imag rounded img' src='./assets/images/K8.jpg'/>";
        ...
        section.item.push({
            ...
            intro:"Eskoriatzako I. Osasun Astearen bueltan, gaur jaialditxoa egingo dute plazan, 18:00etan. Besteak beste, bizitza osasungarria eroateko aholkuak jasotzen dituzten informazio panelak, eliptikoak, umeendako fruta tailerrak eta saski ekologikoaren zozketa izango dira horretan.",
            ...
            txt_publi: "eniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
            author: "Goiena",
        ...
        section.item.push({
            ...
            intro:"Taldea sortzen bada, datorren astean hasiko da zumba ikastaroa. Ostiral arratsaldetan eskainiko da ikastaro berritzaile hau. Ordubetez, 17:00tatik aurrera izango da eta 15 urte gorakoentzat da. Diru kontuei dagokionez, bazkide izanda 9 euro ordaindu beharko dira hilabeteko.",
            text: K2+"Taldea sortzen bada, datorren astean hasiko da zumba ikastaroa. Ostiral arratsaldetan eskainiko da ikastaro berritzaile hau. Ordubetez, 17:00tatik aurrera izango da eta 15 urte gorakoentzat da. Diru kontuei dagokionez, bazkide izanda 9 euro ordaindu beharko dira hilabeteko. Ez bazkideek aldiz, 17 euro hilabeteko eta ekintza plusa dutenentzako doan izango da.",
            txt_publi: "eniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
            author: "Goiena",
        ...
        section.item.push({
            ...
            intro:"Pasa den zapatuan, hilaren 7an, Hanka Labanka patinatzaile taldeko hiru aramaioarrek parte hartu zuten Euskadiko Zirkuituko txapelketan: Ainhoa Oianguren eta Oihan Bideburu Junior mailan eta Agustin Oianguren Master-40 mailan. Nahiz eta eguraldiak ez lagundu, giro paregabea sortu zen txapelketan.",
            text: K6+"<p>Pasa den zapatuan, hilaren 7an, Hanka Labanka patinatzaile taldeko hiru aramaioarrek parte hartu zuten Euskadiko Zirkuituko txapelketan: Ainhoa Oianguren eta Oihan Bideburu Junior mailan eta Agustin Oianguren Master-40 mailan. Nahiz eta eguraldiak ez lagundu, giro paregabea sortu zen txapelketan.</p><p>Domekan, hiru aramaioarrek talde moduan jokatu zuten, hiru orduko Kotarreko zirkuituan, Aranda de Dueron, txandaka bueltak ematen. Lasterketa erdiraino hirugarren postuan mantentzea lortu zuten, baina, azkenean, laugarren postua eskuratu zuten.</p>",
            txt_publi: "eniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
            author: "Goiena",
...
section.item.push({
    ...
    img: ''
        ...
        section.item.push({
            ...
            intro:"Orain arte bai Arlabango zein Goierriko auzoetan bakarrik zegoen edukiontzi berdea; bada, leku horietan jarriko ditugu minigune batzuk.</p><p>Ekarpen-guneak dira. Ekarpen-gune nagusia ipini behar dugu herrian. Miniguneak izango dira edukiontzi multzo txikiagoak.",
        ...
        section.item.push({
            ...
            intro:"Plataforma irekia da, hainbat talde, elkarte, alderdi politiko, sindikatu eta norbanakok osatzen dute taldea. Manifestu baten inguruan, teknika horren kontrako ekimenak burutzen ditugu. Asanblada eragile bat dauka taldeak, asanblada irekia.",
...
section.item.push({
    id: section.item.length + 1,
    clase:"noticia publi ert",
    onclick:"",
    cat:"publi",
    catclass:"rounded",
    desc: "eniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
    text: "GUKERE",
    author: "",
    title: "GUKERE",
    date: "",
    img: ''
        ...
        section.item.push({
            ...
            intro:"2002ean hasi ginen atez atekoarekin, baina herriko auzo batean. Eta 2005ean hasi ginen herri osoan, hondakin guztiekin, beirarekin izan ezik. Izan ere, kristala, gaur egun ere, ohiko edukiontzi berdeetan jasotzen dugu.</p><p>6.200 inguru. Bestetik, La Planako Mankomunitatean batzen gara 12 herri; guztira, 32.000 biztanle.",
        ...
        section.item.push({
            ...
            intro:"Vermican enpresako Joseba Sanchezek bisita horietan erabiltzaileen zalantzak argitu, konpostagailuaren egoera ikusi, eta konpostaren lagin bat hartzen dutela azaldu du. Lagin hori, gero, laborategira eramaten dute ph-a, hezetasuna eta batez ere gazitasuna neurtzeko.</p><p>Orokorrean, erabiltzaileen zalantza edo kezka nagusiak bi direla kontatu du Sanchezek.",
        ...
        section.item.push({
            ...
            intro:"Bergarako herri plataformak  antolatutako protesta ekimen horrek dagoeneko eskuratu ditu hainbat atxikimendu. Debagoienean, Arrasate Garbik, adibidez, bertan izango dela iragartzeaz gainera, arrasatearrei deialdia egin die manifestazioan parte har dezaten",
        ...
        section.item.push({
            ...
            img: "<img width='100%' class='imag rounded img' src='http://goiena.net/site_media/photologue/photos/cache/SergioTrevin%CC%83o_display.jpg'/>"
        });
        ...
        section.item.push({
            ...
            intro: "Soberakin garbia 37.853,23 eurokoa da. Elgetako udalbatzak martxoko osoko bilkuran aztertu zuen 2012ko likidazioa. Bestela esanda, Udalaren iazko balantze ekonomikoa. Positiboan itxi du Udalak 2012a: alkateak azaldu duenez 52.198,87 euroko soberakinarekin",
            ...
            img: "<img width='100%' class='imag rounded img' src='http://goiena.net/site_media/photologue/photos/cache/Imagen%202_203_display.png'>"
        });

section.item.push({
    id: section.item.length + 1,
    clase:"noticia publi luze",
    onclick:"",
    cat:"publi",
    catclass:"rounded",
    desc: "eniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
    ...
    img: ''
        ...
        section.item.push({
            ...
            img: "<img width='100%' class='imag rounded img' src='http://goiena.net/site_media/photologue/photos/cache/Captura%20de%20pantalla%202013-04-10%20a%20las%2020.17.11_display.jpg'>"
        });
        ...
        section.item.push({
            ...
            img: "<img width='100%' class='imag rounded img' src='http://goiena.net/site_media/photologue/photos/cache/P1200022_display.JPG'>"
        });
        ...
        section.item.push({
            ...
            img: "<img width='100%' class='imag rounded img' src='http://goiena.net/site_media/photologue/photos/cache/P1010499%20copia_display.JPG'>"
        });

    var section_ext = {item:[]};

    var rmPubli = function(){
        var j = 0;
        for(var i = 0; i < section.item.length; i++ ){
            if(section.item[i].cat !== "publi"){
                section_ext.item[j] = section.item[i];
                j++;
            }
        }
    };
...
/*----------------------------------------------------------*//*----------------------------------------------------------*/
        ...
        agenda.item.push({
            ...
            desc: desc("Agenda","ARETXABALETA | Abian da Jakiberri ideia-Lehiaketa, 'Healthy Basque Fast Food' produktu berritzaileak sortzeko asmoz."),
        ...
        agenda.item.push({
            ...
            desc: desc("Agenda","ARRASATE | Asteburuan jokatuko da Debagoieganko XX. Futbito txapelketa."),
            text: "<p>Jakiberri Proiektua, 'Healthy Fast Food' tankerako arin prestatzeko euskal janari berri, naturala, osa- suntsua, anitza eta nutritiboa izango den produktuak lortzeko ikerkuntza proiektua da.</p><p>Jakiberri Proiektuaren asmoa euskal jatorrizko 'Healthy Fast Food' sukal- daritza mota berritzailea sortzea da, Obama Presidentearen legediarekin bat letorkeena.</p><p>Jakiberri Proiektua ISEAk (Corporacion MONDRAGON), JAKIONek eta AZARO FUNDAZIOAk bultzatutakoa da, horre- tarako BASQUE CULINARY CENTER eta HAZI laguntza dutelarik.</p><p>Nahiz eta gaur egun 'Healthy Bas- que Fast Food' eskaintzarik ez egon, Jakiberri Proiektuaren helburua da, gure sormen potentziala, ezagutza, tradizioa eta gure gastronomiako giza kolektiboa uztartzea da eta horrela elikadura mota berria, naturala, osasuntsua, anitza eta nutritiboa lortzeko.</p><p>Jakiberri proiektuaren testuinguruan ideia-lehiaketa bat abian jarri izan da 'Euskal Healthy Fast Food' balizko produktuak aurkitzeko asmoz. 1.000 Euroko sari bat eskainiko zaio propo- samen hoberena aurkeztuko duen parte-hartzaileari. Horretaz gain, irabazlearen ideia edo lehiaketan parte hartuko duen beste edozeinen ideia komertzializatuko balitz, Jakibe- rri Lan-Taldeak bere proposatzailea saritu egingo luke. Lehiaketari buruz argibideak eskuratzeko ISEAko webgu- nera (www.iseamcc.net) edo ELKAR- BIDE (www.elkarbide.net) webgune sozialera jo daiteke. Bertan lehiake- taren arauaz gain, parte hartzeko galdera-formulategiak aurkitu ahal</p>",
            author: "",
        ...
        agenda.item.push({
            ...
            cat:"Agenda",
            catclass:"catHeaderMin berdea rounded",
            desc: desc("Agenda","BERGARA | Asteburuan jokatuko da Debagoieganko XX. Futbito txapelketa."),
        ...
        agenda.item.push({
            ...
            cat:"Agenda",
            catclass:"catHeaderMin berdea rounded",
            desc: desc("Agenda","ESKORIATZA | Udalak antolatu ditu Xake txapelketak."),
            text: "<video width='400' height='240' controls><source src='./movie.mp4' type='video/mp4'>Your browser does not support the video tag.</video>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
            author: "",
            title: "Udalak antolatu ditu Xake txapelketak",
            date: "",
            img: ""
        });
        ...
        agenda.item.push({
            ...
            cat:"Gertukoak",
            catclass:"catHeaderMin berdea rounded withImg",
            desc: desc("Agenda","ARRASATE | Vasco-Navarro trenbidearen itxieraren gaineko erakusketa."),
            text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
            author: "",
            title: "Vasco-Navarro trenbidearen itxieraren gaineko erakusketa.",
            date: "",
            img: ''
        });
        ...
        agenda.item.push({
            ...
            cat:"Gertukoak",
            catclass:"catHeaderMin berdea rounded",
            desc: desc("Agenda","BERGARA | Etxeko gazteenak igerilekuan, arrainak itsasoan bezala."),
            text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
            author: "",
            title: "Etxeko gazteenak igerilekuan, arrainak itsasoan bezala",
            date: "",
            img: ""
        });
        ...
        agenda.item.push({
            ...
            cat:"Gertukoak",
            catclass:"catHeaderMin berdea rounded",
            desc: desc("Agenda","ESKORIATZA | Dozena bat neska-mutiko futbolean Gabonetako lehiaketan"),
            text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
            author: "",
            title: "Dozena bat neska-mutiko futbolean Gabonetako lehiaketan",
            date: "",
            img: ""
        });
        ...
        agenda.item.push({
            ...
            cat:"Gertukoak",
            catclass:"catHeaderMin berdea rounded",
            desc: desc("Agenda","ARRASATE | Etxeko gazteenak igerilekuan, arrainak itsasoan bezala."),
            text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
            author: "",
            title: "Etxeko gazteenak igerilekuan, arrainak itsasoan bezala.",
            date: "",
        ...
        agenda.item.push({
            ...
            cat:"Gertukoak",
            catclass:"catHeaderMin berdea rounded",
            desc: desc("Agenda","BERGARA | Dozena bat neska-mutiko futbolean Gabonetako lehiaketan"),
            text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
            author: "",
            title: "Dozena bat neska-mutiko futbolean Gabonetako lehiaketan",
            date: "",
        ...
        agenda.item.push({
            ...
            cat:"Zaletasunak",
            catclass:"catHeaderMin berdea rounded withImg",
            desc: desc("Agenda","ESKORIATZA | Abian da Jakiberri ideia-Lehiaketa, 'Healthy Basque Fast Food' produktu berritzaileak sortzeko asmoz."),
            text: "<p>Jakiberri Proiektua, 'Healthy Fast Food' tankerako arin prestatzeko euskal janari berri, naturala, osa- suntsua, anitza eta nutritiboa izango den produktuak lortzeko ikerkuntza proiektua da.</p><p>Jakiberri Proiektuaren asmoa euskal jatorrizko 'Healthy Fast Food' sukal- daritza mota berritzailea sortzea da, Obama Presidentearen legediarekin bat letorkeena.</p><p>Jakiberri Proiektua ISEAk (Corporacion MONDRAGON), JAKIONek eta AZARO FUNDAZIOAk bultzatutakoa da, horre- tarako BASQUE CULINARY CENTER eta HAZI laguntza dutelarik.</p><p>Nahiz eta gaur egun 'Healthy Bas- que Fast Food' eskaintzarik ez egon, Jakiberri Proiektuaren helburua da, gure sormen potentziala, ezagutza, tradizioa eta gure gastronomiako giza kolektiboa uztartzea da eta horrela elikadura mota berria, naturala, osasuntsua, anitza eta nutritiboa lortzeko.</p><p>Jakiberri proiektuaren testuinguruan ideia-lehiaketa bat abian jarri izan da 'Euskal Healthy Fast Food' balizko produktuak aurkitzeko asmoz. 1.000 Euroko sari bat eskainiko zaio propo- samen hoberena aurkeztuko duen parte-hartzaileari. Horretaz gain, irabazlearen ideia edo lehiaketan parte hartuko duen beste edozeinen ideia komertzializatuko balitz, Jakibe- rri Lan-Taldeak bere proposatzailea saritu egingo luke. Lehiaketari buruz argibideak eskuratzeko ISEAko webgu- nera (www.iseamcc.net) edo ELKAR- BIDE (www.elkarbide.net) webgune sozialera jo daiteke. Bertan lehiake- taren arauaz gain, parte hartzeko galdera-formulategiak aurkitu ahal</p>",
            author: "",
            title: "Abian da Jakiberri ideia-Lehiaketa, 'Healthy Basque Fast Food' produktu berritzaileak sortzeko asmoz.",
            date: "",
        ...
        agenda.item.push({
            ...
            text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
            author: "",
            title: "Asteburuan jokatuko da Debagoieganko XX. Futbito txapelket",
            date: "",
            img: ""
        });
        ...
        agenda.item.push({
            ...
            cat:"Kirol agenda",
            catclass:"catHeaderMin berdea rounded withImg",
            desc: desc("Kirol agenda","ARRASATE | Asteburuan jokatuko da Debagoieganko XX. Futbito txapelketa."),
            text: "<p>Jakiberri Proiektua, 'Healthy Fast Food' tankerako arin prestatzeko euskal janari berri, naturala, osa- suntsua, anitza eta nutritiboa izango den produktuak lortzeko ikerkuntza proiektua da.</p><p>Jakiberri Proiektuaren asmoa euskal jatorrizko 'Healthy Fast Food' sukal- daritza mota berritzailea sortzea da, Obama Presidentearen legediarekin bat letorkeena.</p><p>Jakiberri Proiektua ISEAk (Corporacion MONDRAGON), JAKIONek eta AZARO FUNDAZIOAk bultzatutakoa da, horre- tarako BASQUE CULINARY CENTER eta HAZI laguntza dutelarik.</p><p>Nahiz eta gaur egun 'Healthy Bas- que Fast Food' eskaintzarik ez egon, Jakiberri Proiektuaren helburua da, gure sormen potentziala, ezagutza, tradizioa eta gure gastronomiako giza kolektiboa uztartzea da eta horrela elikadura mota berria, naturala, osasuntsua, anitza eta nutritiboa lortzeko.</p><p>Jakiberri proiektuaren testuinguruan ideia-lehiaketa bat abian jarri izan da 'Euskal Healthy Fast Food' balizko produktuak aurkitzeko asmoz. 1.000 Euroko sari bat eskainiko zaio propo- samen hoberena aurkeztuko duen parte-hartzaileari. Horretaz gain, irabazlearen ideia edo lehiaketan parte hartuko duen beste edozeinen ideia komertzializatuko balitz, Jakibe- rri Lan-Taldeak bere proposatzailea saritu egingo luke. Lehiaketari buruz argibideak eskuratzeko ISEAko webgu- nera (www.iseamcc.net) edo ELKAR- BIDE (www.elkarbide.net) webgune sozialera jo daiteke. Bertan lehiake- taren arauaz gain, parte hartzeko galdera-formulategiak aurkitu ahal</p>",
            author: "",
            title: "Asteburuan jokatuko da Debagoieganko XX. Futbito txapelketa",
            date: "",
...
/*----------------------------------------------------------*//*----------------------------------------------------------*/
        ...
        gertu.item.push({
            ...
            cat:"Zaletasunak",
            catclass:"catHeaderMin horia rounded",
            desc: "1 >  | Abian da Jakiberri ideia-Lehiaketa, 'Healthy Basque Fast Food' produktu berritzaileak sortzeko asmoz.",
            text: "<p>Jakiberri Proiektua, 'Healthy Fast Food' tankerako arin prestatzeko euskal janari berri, naturala, osa- suntsua, anitza eta nutritiboa izango den produktuak lortzeko ikerkuntza proiektua da.</p><p>Jakiberri Proiektuaren asmoa euskal jatorrizko 'Healthy Fast Food' sukal- daritza mota berritzailea sortzea da, Obama Presidentearen legediarekin bat letorkeena.</p><p>Jakiberri Proiektua ISEAk (Corporacion MONDRAGON), JAKIONek eta AZARO FUNDAZIOAk bultzatutakoa da, horre- tarako BASQUE CULINARY CENTER eta HAZI laguntza dutelarik.</p><p>Nahiz eta gaur egun 'Healthy Bas- que Fast Food' eskaintzarik ez egon, Jakiberri Proiektuaren helburua da, gure sormen potentziala, ezagutza, tradizioa eta gure gastronomiako giza kolektiboa uztartzea da eta horrela elikadura mota berria, naturala, osasuntsua, anitza eta nutritiboa lortzeko.</p><p>Jakiberri proiektuaren testuinguruan ideia-lehiaketa bat abian jarri izan da 'Euskal Healthy Fast Food' balizko produktuak aurkitzeko asmoz. 1.000 Euroko sari bat eskainiko zaio propo- samen hoberena aurkeztuko duen parte-hartzaileari. Horretaz gain, irabazlearen ideia edo lehiaketan parte hartuko duen beste edozeinen ideia komertzializatuko balitz, Jakibe- rri Lan-Taldeak bere proposatzailea saritu egingo luke. Lehiaketari buruz argibideak eskuratzeko ISEAko webgu- nera (www.iseamcc.net) edo ELKAR- BIDE (www.elkarbide.net) webgune sozialera jo daiteke. Bertan lehiake- taren arauaz gain, parte hartzeko galdera-formulategiak aurkitu ahal</p>",
            author: "",
            title: "Abian da Jakiberri ideia-Lehiaketa, 'Healthy Basque Fast Food' produktu berritzaileak sortzeko asmoz.",
            date: "",
...
/*----------------------------------------------------------*//*----------------------------------------------------------*/
        ...
        var html2 = Mustache.to_html(Template.extendida(), section_ext);
        $('#extendidas').html(html2);

        var html3 = Mustache.to_html(Template.noticia(), agenda);
        $('#agenda').html(html3);
        var html33 = Mustache.to_html(Template.extendida(), agenda);
        $('#agenda_ext').html(html33);
