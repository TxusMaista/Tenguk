...
Events = (function() {
  ...
  function mas(x) {
    ...
    noticia[def.id].style.padding = "10px";
  ...
  function min() {
    var x = document.getElementsByClassName("noticia");
      ...
      for (var i = 0; i < x.length; i++){
        ...
        x[i].setAttribute("onclick","Events.mas(this);Events.hideAll(this);");
